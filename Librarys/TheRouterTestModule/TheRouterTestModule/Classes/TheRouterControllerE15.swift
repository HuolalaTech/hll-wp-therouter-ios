...
class TheRouterControllerE15: UIViewController {
...
extension TheRouterControllerE15: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE15"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE15()
