...
class TheRouterControllerE20: UIViewController {
...
extension TheRouterControllerE20: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE20"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE20()
