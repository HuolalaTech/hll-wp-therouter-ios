...
class TheRouterControllerE21: UIViewController {
...
extension TheRouterControllerE21: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE21"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE21()
