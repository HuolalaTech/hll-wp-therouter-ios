...
class TheRouterControllerE4: UIViewController {
...
extension TheRouterControllerE4: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE4"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE4()
