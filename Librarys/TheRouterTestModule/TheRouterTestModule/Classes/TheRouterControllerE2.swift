...
class TheRouterControllerE2: UIViewController {
...
extension TheRouterControllerE2: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE2"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE2()
