...
class TheRouterControllerE31: UIViewController {
...
extension TheRouterControllerE31: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE31"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE31()
