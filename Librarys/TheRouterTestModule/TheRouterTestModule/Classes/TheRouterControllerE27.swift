...
class TheRouterControllerE27: UIViewController {
...
extension TheRouterControllerE27: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE27"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE27()
