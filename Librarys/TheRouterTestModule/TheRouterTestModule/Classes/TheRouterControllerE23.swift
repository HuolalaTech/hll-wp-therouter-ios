...
class TheRouterControllerE23: UIViewController {
...
extension TheRouterControllerE23: TheRouterable {
    static var patternString: [String] {
        ["scheme://router/demoE23"]
    }
    
    static func registerAction(info: [String : Any]) -> Any {
        
        let vc =  TheRouterControllerE23()
